...
checkpoint_config = dict(interval=250000, save_optimizer=True, by_epoch=False)
...
load_from = None
resume_from = '/root/autodl-tmp/MSR_20_b8_d01_1m/iter_750000.pth'
workflow = [('train', 1)]
